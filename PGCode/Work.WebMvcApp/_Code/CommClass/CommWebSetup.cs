...
namespace DotWeb.CommSetup
{
    ...
    {
        public static ImageUpScope Main
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 1, KindName = "Main", LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){ SizeFolder=220, width=160, heigh =227}
                };
                return imUp;
            }
        }
        public static ImageUpScope Series
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 100, KindName = "Series", LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){ SizeFolder=80, width=400},
                    new ImageSizeParm(){ SizeFolder=550, width=60}
                };
                return imUp;
            }
        }
